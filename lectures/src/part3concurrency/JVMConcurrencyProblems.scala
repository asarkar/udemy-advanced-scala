...
object JVMConcurrencyProblems:
  ...
  /** Exercises 1 - create "inception threads" thread 1 -> thread 2 -> thread 3 .... each thread prints "hello from
    * thread $i" Print all messages IN REVERSE ORDER
    *
    * 2 - What's the max/min value of x? 3 - "sleep fallacy": what's the value of message?
    */
  // 1 - inception threads
